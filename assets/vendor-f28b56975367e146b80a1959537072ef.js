...
o.forEach(function(e){e.defaultOptions=i}),e[r]=o}e[r]=Ember.makeArray(e[r]),e[r].forEach(function(e){e.globalOptions=t})})}(E,w),Ember.Mixin.create((h(e={init:function(){this._super.apply(this,arguments),v=(Ember.get(this,c.VALIDATIONS_MIXIN_COUNT)||0)+1,Ember.set(this,c.VALIDATIONS_MIXIN_COUNT,v)}},c.VALIDATIONS_CLASS,Ember.computed(function(){var e
return r||(((0,s.default)(this,c.VALIDATIONS_CLASS)||v>1)&&(e=this._super()),r=function(e,r,s){var d={},v=Object.keys(r)
...
return S.reopenClass(h({},c.IS_VALIDATIONS_CLASS,!0)),S}(e,E,this)),r}).readOnly()),h(e,"validations",Ember.computed(function(){return this.get(c.VALIDATIONS_CLASS).create({model:this})}).readOnly()),h(e,"validate",function(){var e
...
return(e=Ember.get(this,"validations")).validateAttribute.apply(e,arguments)}),h(e,"destroy",function(){this._super.apply(this,arguments),Ember.get(this,"validations").destroy()}),e))}}),define("ember-cp-validations/validations/result-collection",["exports","ember-cp-validations/utils/cycle-breaker","ember-cp-validations/utils/array"],function(e,t,r){"use strict"
