...
<head>
    <meta charset="utf-8">
    <title>node_modules/ember-validators/addon/confirmation.js - Ember CP Validations</title>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="nav">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="https://github.com/adopted-ember-addons/ember-cp-validations" class="fa fa-github github"></a></li>
          </ul>
        </div>
      </div>
    </nav>
                ...
                <li class="panel panel-default">
                    ...
                    <li class="panel panel-default">
                        <div class="panel-heading" role="tab" id="sidebar-version-heading">
                            <h4 class="panel-title">
                                <a role="button" href="https://github.com/adopted-ember-addons/ember-cp-validations/commits/v4.0.0-beta.13" target="_blank">
                                  Tag: v4.0.0-beta.13
                                </a>
                            </h4>
                        </div>
